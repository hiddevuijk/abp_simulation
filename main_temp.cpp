...
int main(int argc, char *argv[])
{
	...
	int navg;
	int N, seed;
	double Dt,Dr,v0,Tbase,T,omega0,beta,eps,sigma,L,dt,tf,teq;
	double rho;
	...
	read_variables_temp(N,rho,Dt,Dr,v0,Tbase,T,omega0,beta,eps,
	...
	Deriv deriv(N,L,Dt,Dr,v0,Tbase,T,omega,beta,eps,sigma,seed);
